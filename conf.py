...
BLOG_SUBTITLE = "... because sometimes it's the only way"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://fixitinfirmware.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://hempeldesignroup.com/"
BLOG_EMAIL = "rhempel@fixitinfirmware.com"
BLOG_DESCRIPTION = "A site dedicated to care and feeding of embedded systems"  # (translatable)
...
#       ('https://github.com/rhempel', 'My Github', 'fab fa-github'),
    ),
}
